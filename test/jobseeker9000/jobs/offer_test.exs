...
#         {:ok, %Jobs.Company.Schema{offers: [offer]}} = Jobs.link_offers(company, offer)
#         [offer: offer]
#       else
#         [offer: offer]
#       end
...
#       # assert %Jobs.Company.Schema{url: @dummy_url_1} = Jobs.get_company(offer)
#       assert :no = Jobs.get_company(offer)
#     end
